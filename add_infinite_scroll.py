# Add founding members with infinite scroll
with open('index.html', 'r', encoding='utf-8') as f:
    content = f.read()

# Find the insertion point
marker = '                <!-- Year Selector for Leadership -->'
...
# Founding Members HTML with infinite scroll
founding_html = '''                <!-- Founding Members Section -->
                <div class="mb-12">
...
# Insert
new_content = content[:insertion_point] + founding_html + content[insertion_point:]

with open('index.html', 'w', encoding='utf-8') as f:
    f.write(new_content)

print("Successfully added founding members with infinite scroll!")
